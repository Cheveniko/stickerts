...
const directConvexErrorMessages = {
  ...
  CONTACT_METHOD_REQUIRED: m.error_contact_method_required,
  CONTACT_VALUE_REQUIRED: m.error_contact_value_required,
  CONTACT_EMAIL_INVALID: m.error_contact_email_invalid,
  CONTACT_PHONE_INVALID: m.error_contact_phone_invalid,
