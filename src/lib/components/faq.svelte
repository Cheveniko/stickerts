	...
	const faqs = [
		{
			...
			answer:
				'Marketplace P2P para comprar, vender e intercambiar cromos físicos de álbumes. Conectamos coleccionistas para que puedan completar sus álbumes o deshacerse de sus repetidos.'
		},
		{
		...
		},
		{
			...
			answer:
				'Es un acceso único de $1.99 USD que desbloquea tu perfil de vendedor durante todo el 2026. Con él puedes publicar tus cromos, contactar vendedores sin límite y recibir mensajes directos de compradores.'
		},
		{
		...
		},
		{
			...
			answer:
				'Al publicar un cromo puedes marcarlo como "Intercambio". El comprador te contacta y le puedes ofrecer tus repetidos a cambio del cromo que él tiene. Todo se coordina directamente entre ustedes por WhatsApp o correo.'
		}
	];
...
<section class="space-y-6">
	...
	<div
		class="divide-border ring-foreground/5 w-full divide-y overflow-hidden rounded-4xl ring-1"
